...
<div class="py-3">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" name="contact" id="contact" class="form-control form-control-border border-navy" 
                   required maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" oninput="validateContact(this)">
        </div>
    </div>
</div>
